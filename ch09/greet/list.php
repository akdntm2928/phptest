...
<html>
    <head>
        ...
        <?php }
           $sql="select * from phptest.greet where $find like '%$search%' order by num desc";
        } else{
            $sql ='select * from phptest.greet order by num desc';
        }
        try {
            $stmh =$pdo->query($sql);
            $count=$stmh->rowCount();
                ...
                <div id="col2">
                    ...
                    <div id="list_content">
                        ...
                        if(isset($_SESSION['userid'])){                        ?>
                            <a href="wirte_form.php"><img src="../img/write.png"></a> 
                       <?php } ?>
                        </div>
                    </div>
                    <?php 
